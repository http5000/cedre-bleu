    ...
    <footer className="bg-[#0d1f3a] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="text-[#C9A227] text-xs tracking-widest uppercase mb-4">
              Spécialités libanaises
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Restaurant libanais authentique à Lyon 5. Une cuisine faite maison avec amour et
              convivialité.
            </p>
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-[#C9A227] text-xs font-semibold uppercase tracking-widest mb-4">
              Navigation
            </h3>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-block px-5 py-2.5 bg-[#C9A227] text-white text-sm font-semibold rounded-full hover:bg-[#a88220] transition-colors"
            >
              Réserver une table
            </a>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-500">
          ...
          <span>
            Réalisation{" "}
            <a href="https://yumea.fr" className="hover:text-gray-300 transition-colors">
              Yumea.fr
            </a>
          </span>
        </div>
